...
class TicketCardPaymentScreen extends StatefulWidget {
  @override
  _TicketCardPaymentScreenState createState() => _TicketCardPaymentScreenState();
}

class _TicketCardPaymentScreenState extends State<TicketCardPaymentScreen> {
                      ...
                      onPressed: () {
                        if (_formKey.currentState!.validate()) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Your Ticket is booked')),
                          );
