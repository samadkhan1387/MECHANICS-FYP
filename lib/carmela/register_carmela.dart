...
class RegisterCarMela extends StatefulWidget {
  @override
  _RegisterCarState createState() => _RegisterCarState();
}

class _RegisterCarState extends State<RegisterCarMela> {
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            NotificationScreen.addNotification(
                              'Your car with No-Plate $carNoPlate has been registered for Car Mela.',
                            );

                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(content: Text('Your car has been registered for Car Mela')),
                            );
                          }
                        },
                        style: ButtonStyle(
